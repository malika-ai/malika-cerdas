...
export const Booking: React.FC = () => {
  ...
  return (
    <Section id="booking" className="mb-20 bg-transparent">
      <GlassCard className="max-w-5xl mx-auto overflow-hidden bg-white/80 shadow-2xl shadow-blue-900/10 backdrop-blur-md">
